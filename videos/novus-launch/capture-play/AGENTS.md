...
Source: http://localhost:3000/play
...
| `extracted/tokens.json` | Design tokens: 9 colors, 6 fonts, 1 headings, 0 CTAs |
...
- **Colors**: #EDEBE6 (bg-light), #232019 (surface-dark), #FCFCFC (bg-light), #E35F00 (accent), #FFFFFF (bg-light), #F2F0EC (bg-light), #E3DFD8 (surface-light), #241F16 (surface-dark), #FFB900 (surface-light)
