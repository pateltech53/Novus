  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col px-6 pt-[max(1.5rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))]">
      ...
      <div className="mt-auto w-full pt-8">
        ...
        {/* The one place in the app where free stops the player from playing at
            all rather than from playing wider, so the way out is a control
            rather than a line of grey text under a disabled button. */}
        {slotsLeft === 0 && (
          <button
            type="button"
