...
export const metadata: Metadata = {
  title: "Get Novus — iPhone, Android, or the browser | novuspitch.com",
  description:
  ...
  alternates: { canonical: "https://novuspitch.com/download" },
  openGraph: {
    type: "website",
    ...
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Novus" }],
  },
};
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-6 pt-[max(2.5rem,env(safe-area-inset-top))] pb-[max(3rem,env(safe-area-inset-bottom))]">
      ...
      <p className="mt-4 max-w-[34rem] text-base leading-relaxed text-[var(--text-secondary)]">
        Same game on every one of these, and the same save behind it. Months are
        free. The year costs you a pitch, out loud, on camera.
      </p>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        ...
        <section className="nv-card flex flex-col p-5">
          <div className="flex items-center gap-2.5">
            <AppleMark />
            <h2 className="text-lg font-extrabold tracking-[-0.01em]">iPhone</h2>
          </div>
        ...
        <section className="nv-card flex flex-col p-5">
          <div className="flex items-center gap-2.5">
            <AndroidMark />
            <h2 className="text-lg font-extrabold tracking-[-0.01em]">Android</h2>
          </div>
          <p className="mt-2 flex-1 text-sm leading-relaxed text-[var(--text-secondary)]">
      ...
      <section className="nv-card mt-4 flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-lg font-extrabold tracking-[-0.01em]">Any browser</h2>
      ...
      <section className="mt-10">
        ...
        <ol className="mt-3 space-y-2 text-sm leading-relaxed text-[var(--text-secondary)]">
          <li>
            <span className="font-bold text-[var(--text-primary)]">1.</span> Open
            this page on the phone and tap Download the APK.
          </li>
          <li>
            <span className="font-bold text-[var(--text-primary)]">2.</span>{" "}
            Android will ask whether your browser may install apps. It only ever
            asks once per browser.
          </li>
          <li>
            <span className="font-bold text-[var(--text-primary)]">3.</span> Open
        ...
        <p className="mt-4 text-2xs leading-relaxed text-[var(--text-tertiary)]">
          ...
          because a direct APK is not distributed through the Play Store. Builds
          are produced in public by GitHub Actions — the workflow that made the
          file you are downloading is in this repository.
        </p>
      </section>
...
function AppleMark() {
  return (
    <svg width="18" height="22" viewBox="0 0 17 21" fill="currentColor" aria-hidden="true">
